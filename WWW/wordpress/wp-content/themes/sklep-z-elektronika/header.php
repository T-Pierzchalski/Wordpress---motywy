...
<meta charset="UTF-8">
  ...
  <nav class="navbar navbar-expand-lg sticky-top nav-color">
    
  <div class="logo ms-3 mt-2 py-4 rounded text-center d-flex flex-column justify-content-center"> 
  <?php if( has_custom_logo() ):  ?>
                        ...
                        <a class="navbar-brand fs-2 fw-bold" href="<?php echo esc_url( home_url( '/', 'https' ) ); ?>" 
                        title="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" 
                        rel="home"><h1 class="fs-3 fw-bold">Electronics</h1></a>
  ...
  <div class="top-nav d-flex flex-column">
    ...
    <form class="form-inline" role="search">
      ...
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0  justify-content-center fw-bold text-center">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="#">Sprzęt rtv</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">Sprzęt fotograficzny</a>
        </li>
      </ul>
    </div>
  </div>
